...
func _on_quick_convert_pressed():
	...
	var input_path = ProjectSettings.get_setting("excel_converter/input_path", plugin_path + "/data/")
...
func _on_settings_pressed():
	"""设置按钮"""
	var settings_dialog = load(plugin_path + "/settings_dialog.tscn").instantiate()
